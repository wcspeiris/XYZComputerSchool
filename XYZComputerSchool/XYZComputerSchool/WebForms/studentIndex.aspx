<%@ Page Title="" Language="C#" MasterPageFile="~/WebForms/XYZStudentMasterPage.Master" AutoEventWireup="true" CodeBehind="studentIndex.aspx.cs" Inherits="XYZComputerSchool.WebForms.studentIndex" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="Bootstrap Custom Designs/Responsive Carousel/carousel.css" rel="stylesheet" />      
    <script src="Bootstrap Custom Designs/Responsive Carousel/carousel-jQuery.js"></script>
</asp:Content>
...
<asp:Content ID="ContentBody" ContentPlaceHolderID="body" runat="server">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12">                 
                <div class="slider">
                    <div class="slide-img"><img src="Images/Carousel Images/Image01.png" class="img-thumbnail" /></div>
                    <div class="slide-img"><img src="Images/Carousel Images/Image02.png" class="img-thumbnail" /></div>
                    <div class="slide-img"><img src="Images/Carousel Images/Image03.png" class="img-thumbnail" /></div>
                </div>
                <div class="points">
                    <ul>
    ...
    <script>
        $(document).ready(function () {
            ...
            */
            ...
            var carousel = new slider($('.slider'), $('.points'), $('.arrow'), 3000);
            carousel.render();
        });
    </script>
