<%@ Page Title="" Language="C#" MasterPageFile="~/WebForms/XYZExamPaper.Master" AutoEventWireup="true" CodeBehind="QuestionPage03.aspx.cs" Inherits="XYZComputerSchool.WebForms.QuestionPage03" %>
        ...
        <div class="row">
            <div class="col-sm-11 col-sm-push-1" style="height:330px">
                <div class="form-group">
                    <br />
                    <asp:HiddenField ID="hf03" runat="server" />
                    <asp:HiddenField ID="hfCorrectAns03" runat="server" />
                    <asp:Label runat="server" Text="03." ID="lbl03"></asp:Label>
                    <asp:Label runat="server" Text="Question" ID="lblQuestion03"></asp:Label><br /><br />                   
                    <asp:RadioButtonList runat="server" ID="rbListQuestion03" AutoPostBack="True" OnSelectedIndexChanged="rbListQuestion03_SelectedIndexChanged">
                    </asp:RadioButtonList>
                </div>
            </div>
        </div>
