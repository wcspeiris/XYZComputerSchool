<%@ Page Title="" Language="C#" MasterPageFile="~/WebForms/XYZExamPaper.Master" AutoEventWireup="true" CodeBehind="QuestionPage07.aspx.cs" Inherits="XYZComputerSchool.WebForms.QuestionPage07" %>
        ...
        <div class="row">
            <div class="col-sm-11 col-sm-push-1" style="height:330px">
                <div class="form-group">
                    <br />
                    <asp:HiddenField ID="hf07" runat="server" />
                    <asp:HiddenField ID="hfCorrectAns07" runat="server" />
                    <asp:Label runat="server" Text="07." ID="lbl07"></asp:Label>
                    <asp:Label runat="server" Text="Question" ID="lblQuestion07"></asp:Label><br /><br />                   
                    <asp:RadioButtonList runat="server" ID="rbListQuestion07" AutoPostBack="True" OnSelectedIndexChanged="rbListQuestion07_SelectedIndexChanged">
                    </asp:RadioButtonList>
                </div>
            </div>
        </div>
