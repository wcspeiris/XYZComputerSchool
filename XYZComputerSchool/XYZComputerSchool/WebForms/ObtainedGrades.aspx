<%@ Page Title="" Language="C#" MasterPageFile="~/WebForms/XYZStudentMasterPage.Master" AutoEventWireup="true" CodeBehind="ObtainedGrades.aspx.cs" Inherits="XYZComputerSchool.WebForms.ObtainedGrades" %>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-10 table-responsive" style="overflow-x: auto">
                    <asp:GridView ID="GridViewStudentObtainedGrades" runat="server" AutoGenerateColumns="False" EmptyDataText="There are no data records to display." CellPadding="4" ForeColor="#333333" GridLines="None" CssClass="mGrid" AlternatingRowStyle-CssClass="alt" PagerStyle-CssClass="pgr" AllowPaging="True" PageSize="7" OnSelectedIndexChanged="GridViewStudentObtainedGrades_SelectedIndexChanged" OnPageIndexChanging="GridViewStudentObtainedGrades_PageIndexChanging">
                ...
                <div class="col-sm-2">
                    <div class="text-center">
                        <asp:Label ID="lblOverallAverageScore" runat="server" Text=""><h5>Overall Average Score</h5></asp:Label>
                        <h5>
                            <asp:Label ID="lblAverageScore" runat="server" Text=""></asp:Label></h5>
                    </div>
                    <div>
                        <br />
