<%@ Page Title="" Language="C#" MasterPageFile="~/WebForms/XYZExamPaper.Master" AutoEventWireup="true" CodeBehind="QuestionPage04.aspx.cs" Inherits="XYZComputerSchool.WebForms.QuestionPage04" %>
        ...
        <div class="row">
            <div class="col-sm-11 col-sm-push-1" style="height:330px">
                <div class="form-group">
                    <br />
                    <asp:HiddenField ID="hf04" runat="server" />
                    <asp:HiddenField ID="hfCorrectAns04" runat="server" />
                    <asp:Label runat="server" Text="04." ID="lbl04"></asp:Label>
                    <asp:Label runat="server" Text="Question" ID="lblQuestion04"></asp:Label><br /><br />                   
                    <asp:RadioButtonList runat="server" ID="rbListQuestion04" AutoPostBack="True" OnSelectedIndexChanged="rbListQuestion04_SelectedIndexChanged">
                    </asp:RadioButtonList>
                </div>
            </div>
        </div>
