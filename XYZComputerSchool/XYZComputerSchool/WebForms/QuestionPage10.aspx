<%@ Page Title="" Language="C#" MasterPageFile="~/WebForms/XYZExamPaper.Master" AutoEventWireup="true" CodeBehind="QuestionPage10.aspx.cs" Inherits="XYZComputerSchool.WebForms.QuestionPage10" %>
        ...
        <div class="row">
            <div class="col-sm-11 col-sm-push-1" style="height:330px">
                <div class="form-group">
                    ...
                    <asp:HiddenField ID="hfCorrectAns10" runat="server" />
                    <asp:Label runat="server" Text="10." ID="lbl10"></asp:Label>
                    <asp:Label runat="server" Text="Question" ID="lblQuestion10"></asp:Label><br /><br />                   
                    <asp:RadioButtonList runat="server" ID="rbListQuestion10" AutoPostBack="True" OnSelectedIndexChanged="rbListQuestion10_SelectedIndexChanged">
                    </asp:RadioButtonList>
                </div>
            </div>
        </div>
