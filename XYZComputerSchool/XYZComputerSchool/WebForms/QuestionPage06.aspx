<%@ Page Title="" Language="C#" MasterPageFile="~/WebForms/XYZExamPaper.Master" AutoEventWireup="true" CodeBehind="QuestionPage06.aspx.cs" Inherits="XYZComputerSchool.WebForms.QuestionPage06" %>
        ...
        <div class="row">
            <div class="col-sm-11 col-sm-push-1" style="height:330px">
                <div class="form-group">
                    <br />
                    <asp:HiddenField ID="hf06" runat="server" />
                    <asp:HiddenField ID="hfCorrectAns06" runat="server" />
                    <asp:Label runat="server" Text="06." ID="lbl06"></asp:Label>
                    <asp:Label runat="server" Text="Question" ID="lblQuestion06"></asp:Label><br /><br />                   
                    <asp:RadioButtonList runat="server" ID="rbListQuestion06" AutoPostBack="True" OnSelectedIndexChanged="rbListQuestion06_SelectedIndexChanged">
                    </asp:RadioButtonList>
                </div>
            </div>
        </div>
