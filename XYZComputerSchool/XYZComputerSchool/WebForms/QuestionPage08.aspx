<%@ Page Title="" Language="C#" MasterPageFile="~/WebForms/XYZExamPaper.Master" AutoEventWireup="true" CodeBehind="QuestionPage08.aspx.cs" Inherits="XYZComputerSchool.WebForms.QuestionPage08" %>
        ...
        <div class="row">
            <div class="col-sm-11 col-sm-push-1" style="height:330px">
                <div class="form-group">
                    <br />
                    <asp:HiddenField ID="hf08" runat="server" />
                    <asp:HiddenField ID="hfCorrectAns08" runat="server" />
                    <asp:Label runat="server" Text="08." ID="lbl08"></asp:Label>
                    <asp:Label runat="server" Text="Question" ID="lblQuestion08"></asp:Label><br /><br />                   
                    <asp:RadioButtonList runat="server" ID="rbListQuestion08" AutoPostBack="True" OnSelectedIndexChanged="rbListQuestion08_SelectedIndexChanged">
                    </asp:RadioButtonList>
                </div>
            </div>
        </div>
