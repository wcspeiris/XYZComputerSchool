<%@ Page Title="" Language="C#" MasterPageFile="~/WebForms/XYZExamPaper.Master" AutoEventWireup="true" CodeBehind="QuestionPage09.aspx.cs" Inherits="XYZComputerSchool.WebForms.QuestionPage09" %>
        ...
        <div class="row">
            <div class="col-sm-11 col-sm-push-1" style="height:330px">
                <div class="form-group">
                    <br />
                    <asp:HiddenField ID="hf09" runat="server" />
                    <asp:HiddenField ID="hfCorrectAns09" runat="server" />
                    <asp:Label runat="server" Text="09." ID="lbl09"></asp:Label>
                    <asp:Label runat="server" Text="Question" ID="lblQuestion09"></asp:Label><br /><br />                   
                    <asp:RadioButtonList runat="server" ID="rbListQuestion09" AutoPostBack="True" OnSelectedIndexChanged="rbListQuestion09_SelectedIndexChanged">
                    </asp:RadioButtonList>
                </div>
            </div>
        </div>
