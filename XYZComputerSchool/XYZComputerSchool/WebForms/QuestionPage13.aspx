<%@ Page Title="" Language="C#" MasterPageFile="~/WebForms/XYZExamPaper.Master" AutoEventWireup="true" CodeBehind="QuestionPage13.aspx.cs" Inherits="XYZComputerSchool.WebForms.QuestionPage13" %>
        ...
        <div class="row">
            <div class="col-sm-11 col-sm-push-1" style="height:330px">
                <div class="form-group">
                    <br />
                    <asp:HiddenField ID="hf13" runat="server" />
                    <asp:HiddenField ID="hfCorrectAns13" runat="server" />
                    <asp:Label runat="server" Text="13." ID="lbl13"></asp:Label>
                    <asp:Label runat="server" Text="Question" ID="lblQuestion13"></asp:Label><br /><br />                   
                    <asp:RadioButtonList runat="server" ID="rbListQuestion13" AutoPostBack="True" OnSelectedIndexChanged="rbListQuestion13_SelectedIndexChanged">
                    </asp:RadioButtonList>
                </div>
            </div>
        </div>
