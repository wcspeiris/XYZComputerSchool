<%@ Page Title="" Language="C#" MasterPageFile="~/WebForms/XYZExamPaper.Master" AutoEventWireup="true" CodeBehind="QuestionPage05.aspx.cs" Inherits="XYZComputerSchool.WebForms.QuestionPage05" %>
        ...
        <div class="row">
            <div class="col-sm-11 col-sm-push-1" style="height:330px">
                <div class="form-group">
                    <br />
                    <asp:HiddenField ID="hf05" runat="server" />
                    <asp:HiddenField ID="hfCorrectAns05" runat="server" />
                    <asp:Label runat="server" Text="05." ID="lbl05"></asp:Label>
                    <asp:Label runat="server" Text="Question" ID="lblQuestion05"></asp:Label><br /><br />                   
                    <asp:RadioButtonList runat="server" ID="rbListQuestion05" AutoPostBack="True" OnSelectedIndexChanged="rbListQuestion05_SelectedIndexChanged">
                    </asp:RadioButtonList>
                </div>
            </div>
        </div>
