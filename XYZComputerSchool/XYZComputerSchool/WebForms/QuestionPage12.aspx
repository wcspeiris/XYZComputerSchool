<%@ Page Title="" Language="C#" MasterPageFile="~/WebForms/XYZExamPaper.Master" AutoEventWireup="true" CodeBehind="QuestionPage12.aspx.cs" Inherits="XYZComputerSchool.WebForms.QuestionPage12" %>
        ...
        <div class="row">
            <div class="col-sm-11 col-sm-push-1" style="height:330px">
                <div class="form-group">
                    <br />
                    <asp:HiddenField ID="hf12" runat="server" />
                    <asp:HiddenField ID="hfCorrectAns12" runat="server" />
                    <asp:Label runat="server" Text="12." ID="lbl12"></asp:Label>
                    <asp:Label runat="server" Text="Question" ID="lblQuestion12"></asp:Label><br /><br />                   
                    <asp:RadioButtonList runat="server" ID="rbListQuestion12" AutoPostBack="True" OnSelectedIndexChanged="rbListQuestion12_SelectedIndexChanged">
                    </asp:RadioButtonList>
                </div>
            </div>
        </div>
