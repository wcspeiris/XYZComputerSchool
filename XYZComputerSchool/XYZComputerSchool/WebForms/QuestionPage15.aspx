<%@ Page Title="" Language="C#" MasterPageFile="~/WebForms/XYZExamPaper.Master" AutoEventWireup="true" CodeBehind="QuestionPage15.aspx.cs" Inherits="XYZComputerSchool.WebForms.QuestionPage15" %>
        ...
        <div class="row">
            <div class="col-sm-11 col-sm-push-1" style="height:330px">
                <div class="form-group">
                    <br />
                    <asp:HiddenField ID="hf15" runat="server" />
                    <asp:HiddenField ID="hfCorrectAns15" runat="server" />
                    <asp:Label runat="server" Text="15." ID="lbl15"></asp:Label>
                    <asp:Label runat="server" Text="Question" ID="lblQuestion15"></asp:Label><br /><br />                   
                    <asp:RadioButtonList runat="server" ID="rbListQuestion15" AutoPostBack="True" OnSelectedIndexChanged="rbListQuestion15_SelectedIndexChanged">
                    </asp:RadioButtonList>
                </div>
            </div>
        </div>
